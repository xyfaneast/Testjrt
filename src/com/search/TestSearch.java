...
public class TestSearch {
	...
	public static void main(String[] args) throws Exception{
		HttpRequest req = new HttpRequest(HttpMethod.GET, new URL("http://localhost:8889/queryEmployeeForSearch?userid=1158781&eid=2000&searcheName=shayi&gzip=1&token=queryEmployeeForSearch"));
