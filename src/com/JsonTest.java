...
import com.urapport.eut.main.TokenGenerate;
...
public class JsonTest {
    ...
    public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        String token = TokenGenerate.getToken("abcdefghjkl","","","","","5555","123333");
        String[] checkToken = TokenGenerate.checkToken(token);
        ...
        /*
         * ArrayList<NodeBean> list = new ArrayList<>(); list.add(new
         * NodeBean("1", "1", "1", "1", "1", "1", "1")); list.add(new
         * NodeBean("2", "1", "1", "1", "1", "1", "1")); list.add(new
         * NodeBean("3", "1", "1", "1", "1", "1", "1")); list.add(new
         * NodeBean("4", "1", "1", "1", "1", "1", "1")); String json =
         * gson.toJson(list); ArrayList<NodeBean> list1 = gson.fromJson(json,
         * new TypeToken<ArrayList<NodeBean>>() {}.getType()); for (NodeBean
         * nodeBean : list1) { System.out.println(nodeBean.getNodeId()); }
         */
    }
